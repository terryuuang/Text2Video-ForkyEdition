                ...
                with llm_helper:
                    tips = """
                            ...
                            - **Base Url**: 一般為 http://localhost:11434/v1
                                - 如果 `MoneyPrinterTurbo` 和 `Ollama` **不在同一台機器上**，需要填寫 `Ollama` 機器的IP地址
            ...
            if llm_provider == "g4f":
                ...
                with llm_helper:
                    tips = """
                            ...
                            - **API Key**: 隨便填寫，比如 123
                            - **Base Url**: 留空
                            - **Model Name**: 比如 gpt-4.1-mini，[點擊查看模型列表](https://github.com/xtekky/gpt4free/blob/main/g4f/models.py#L308)
                            """
            if llm_provider == "azure":
                with llm_helper:
                    tips = """
                            ...
                            - **API Key**: [點擊到Azure後台創建](https://portal.azure.com/#view/Microsoft_Azure_ProjectOxford/CognitiveServicesHub/~/OpenAI)
                            - **Base Url**: 留空
            ...
            if llm_provider == "ernie":
                with llm_helper:
                    tips = """
                            ...
                            - **Base Url**: 填寫 **請求地址** [點擊查看文件](https://cloud.baidu.com/doc/WENXINWORKSHOP/s/jlil56u11#%E8%AF%B7%E6%B1%82%E8%AF%B4%E6%98%8E)
                            """
...
with middle_panel:
    ...
    with st.container(border=True):
        ...
        # 檢查保存的聲音是否在當前篩選的聲音列表中
        if saved_voice_name in friendly_names:
            saved_voice_name_index = list(friendly_names.keys()).index(saved_voice_name)
        else:
            # 如果不在，則根據當前UI語言選擇一個默認聲音
        ...
        # 當選擇V2版本或者聲音是V2聲音時，顯示服務區域和API key輸入框
        ...
        if params.bgm_type == "custom":
            ...
            if custom_bgm_file and os.path.exists(custom_bgm_file):
                ...
                # st.write(f":red[已選擇自定義背景音樂]：**{custom_bgm_file}**")
