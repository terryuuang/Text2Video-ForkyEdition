...
<p>This project is forked from <a href="https://github.com/harry0703/MoneyPrinterTurbo">harry0703/MoneyPrinterTurbo</a></p>
<p><strong>Key Improvements:</strong></p>
<ul style="text-align: left; display: inline-block;">
  <li>🌏 <strong>Traditional Chinese Localization</strong> - Complete UI and documentation translation</li>
  <li>🔧 <strong>Bug Fixes</strong> - Fixed known issues from the original version</li>
  <li>✨ <strong>Feature Optimization</strong> - Enhanced user experience for Traditional Chinese users</li>
</ul>
<br>

<h3>English | <a href="README.md">繁體中文</a></h3>
...
- [x] **Traditional Chinese Optimized Version** - Based on the original project with Traditional Chinese localization and bug fixes
...
### Traditional Chinese Version Updates
- 🌏 **Complete Traditional Chinese Localization** - Converted all Simplified Chinese content to Traditional Chinese
- 🔧 **Bug Fixes** - Fixed encoding issues in Chinese environments from the original version
- 📝 **Documentation Translation** - Complete translation of user manuals and error messages
- ✨ **Interface Optimization** - UI adjustments specifically for Traditional Chinese users

### Based on Original Project
- This project is based on [harry0703/MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo) v1.2.6
- Maintains full compatibility with original project features
- Regular synchronization with new features from the original project
